...
# 权利义务种子（RightObligation 节点在 KG 中无 description，术语卡回退用）
CORE_RIGHTS_OBLIGATIONS = {
    "取得劳动报酬的权利": "劳动者依法按时足额获得劳动报酬的权利",
    "休息休假的权利": "劳动者依法享有休息日和法定节假日休息的权利",
    "获得劳动安全卫生保护的权利": "劳动者在劳动过程中获得安全卫生条件保护的权利",
    "享受社会保险和福利的权利": "劳动者依法参加社会保险并享受相应待遇的权利",
    "平等就业和选择职业的权利": "劳动者依法自主择业、不受歧视的权利",
    "接受职业技能培训的权利": "劳动者依法获得职业技能培训的机会",
    "提请劳动争议处理的权利": "劳动者就劳动争议依法申请仲裁、提起诉讼的权利",
    "支付劳动报酬的义务": "用人单位应当按照劳动合同约定及时足额支付劳动者工资",
    "提供劳动保护条件的义务": "用人单位应当提供符合国家标准的劳动安全卫生条件",
    "缴纳社会保险费的义务": "用人单位应当依法为劳动者缴纳社会保险费",
    "依法订立书面劳动合同的义务": "用人单位应当自用工之日起一个月内与劳动者订立书面劳动合同",
}
